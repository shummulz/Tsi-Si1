...
export const userData = [
	...
	{ 
		...
		maintenanceFee: 100,
		paymentStatus: "Paid",
		lastPayment: "September 27 2025", // Current month payment
		paymentForMonth: "September 2025", // Which month this payment covers
		dueDate: "November 5, 2025", // Next payment due date
		accessCard: "Active",
		// Leaderboard tracking data
	...
	{ 
		...
		maintenanceFee: 100,
		paymentStatus: "Paid",
		lastPayment: "October 28, 2025", // 6 months overdue - access blocked
		paymentForMonth: "October 2025", // Which month this payment covers
	...
	{ 
		...
		maintenanceFee: 100,
		paymentStatus: "Paid",
		lastPayment: "October 6, 2025", // 2 months overdue - final warning
		paymentForMonth: "December 2025", // Which month this payment covers
		dueDate: "February 5, 2026", // Was due in June, now overdue
		accessCard: "Active",
		// Leaderboard tracking data
		consecutiveOnTimePayments: 12,
	...
	{ 
		...
		maintenanceFee: 100,
		paymentStatus: "Paid",
		lastPayment: "October 7 2025", // 2 months overdue - final warning
		paymentForMonth: "September 2025", 
		dueDate: "November 5, 2025", // Was due in June, now overdue
		accessCard: "Active",
		// Leaderboard tracking data
		consecutiveOnTimePayments: 9,
		earlyPayments: 0,
	...
	{ 
		...
		maintenanceFee: 100,
		paymentStatus: "Paid",
		lastPayment: "August 14, 2025", // 2 months overdue - final warning
		paymentForMonth: "August 2025", 
	...
	{ 
		...
		maintenanceFee: 100,
		paymentStatus: "Paid",
		lastPayment: "October 27, 2025",
		paymentForMonth: "November 2025", // Which month this payment covers
		dueDate: "January 5, 2026",
		accessCard: "Active",
		// Leaderboard tracking data
		consecutiveOnTimePayments: 11,
		earlyPayments: 11,
		totalPaymentsMade: 11,
		averageDaysEarly: 11,
		paymentStreak: 11,
		badges: ["Consistent", "Reliability Star", "Super Early Bird", "MVP", "Early Bird"]
	},
	{ 
		id: 19, 
		name: "Ku Asraf", 
	...
	{ 
		...
		lastPayment: "October 7,2025", // 2 months overdue - final warning
		paymentForMonth: "October  2025", // Which month this payment covers
		dueDate: "December 5, 2025", // Was due in June, now overdue
		accessCard: "Active",
		// Leaderboard tracking data
		consecutiveOnTimePayments: 10,
		earlyPayments: 10,
...
export const getPaymentStatus = (user) => {
	...
	const lastPaymentMonth = paymentForMonth.getMonth();
	const lastPaymentYear = paymentForMonth.getFullYear();
...
export const getAutoAccessCardStatus = (user) => {
	...
	if (user.paymentStatus === "Paid") {
		...
		const currentMonth = currentDate.getMonth();
		const currentYear = currentDate.getFullYear();
		const paymentForMonthMonth = paymentForMonth.getMonth();
		const paymentForMonthYear = paymentForMonth.getFullYear();
		
		if (paymentForMonthMonth === currentMonth && paymentForMonthYear === currentYear) {
